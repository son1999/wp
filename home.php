...
<div id="preloader"><div class="circles"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div>
		<div id="wrap">
			<nav id="nav-logo-menu-btn-2" class="navbar navbar-expand-lg light">
        			...
        			<div class="row align-items-center">
            			<div class="col-auto">
                			<a class="navbar-brand smooth" href="<?php echo get_site_url();?>" target="_self">
                    			<img src="<?php echo get_template_directory_uri();?>/images/background/modal-loader.gif" data-src="<?php echo get_template_directory_uri();?>/images/1200pxVinhomes_logo.svg.png" height="50px" class="lazy mw-100" alt="">
                			</a>
            			</div>
            			...
            			<div class="col-lg-auto collapse navbar-collapse main-menu-collapse mr-auto">
                			<ul class="navbar-nav">
                    			...
                    			<li class="nav-item">
                        			<a class="nav-link smooth" href="<?php echo get_site_url();?>/smart-city/" target="_self">Dự án</a>
                    			</li>
                    			<li class="nav-item">
            			...
            			<div class="col-auto collapse navbar-collapse main-menu-collapse">
                			<div class="">
                    			<a class="btn btn-primary smooth fx-btn-glow" href="tel:0968223425" style="font-size: 20px;" target="_self"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 320 512" class="icon icon-pos-left" style="fill: rgb(255, 255, 255);"><path d="M272 0H48C21.5 0 0 21.5 0 48v416c0 26.5 21.5 48 48 48h224c26.5 0 48-21.5 48-48V48c0-26.5-21.5-48-48-48zM160 480c-17.7 0-32-14.3-32-32s14.3-32 32-32 32 14.3 32 32-14.3 32-32 32zm112-108c0 6.6-5.4 12-12 12H60c-6.6 0-12-5.4-12-12V60c0-6.6 5.4-12 12-12h200c6.6 0 12 5.4 12 12v312z"></path></svg><strong class="">0968 223 425</strong></a>
                			</div>
            			</div>
        			</div>
    			</div>
    			...
    			<img src="<?php echo get_template_directory_uri();?>/images/background/modal-loader.gif" data-src="<?php echo get_template_directory_uri();?>/images/chinhsachvinhomesonline_1_1min.jpg" alt="image" class="lazy item w-100">
    			<img src="<?php echo get_template_directory_uri();?>/images/background/modal-loader.gif" data-src="<?php echo get_template_directory_uri();?>/images/chinhsachvinhomesonline_2_1min.jpg" alt="image" class="lazy item w-100">
    			<img src="<?php echo get_template_directory_uri();?>/images/background/modal-loader.gif" data-src="<?php echo get_template_directory_uri();?>/images/chinhsachvinhomesonline_7min.jpg" alt="image" class="lazy item w-100">
    			<img src="<?php echo get_template_directory_uri();?>/images/background/modal-loader.gif" data-src="<?php echo get_template_directory_uri();?>/images/chinhsachvinhomesonline_3min.jpg" alt="image" class="lazy item w-100">
    			<img src="<?php echo get_template_directory_uri();?>/images/background/modal-loader.gif" data-src="<?php echo get_template_directory_uri();?>/images/chinhsachvinhomesonline_4min.jpg" alt="image" class="lazy item w-100">
    			<img src="<?php echo get_template_directory_uri();?>/images/background/modal-loader.gif" data-src="<?php echo get_template_directory_uri();?>/images/chinhsachvinhomesonline_5min.jpg" alt="image" class="lazy item w-100">
    			<img src="<?php echo get_template_directory_uri();?>/images/background/modal-loader.gif" data-src="<?php echo get_template_directory_uri();?>/images/chinhsachvinhomesonline_6min.jpg" alt="image" class="lazy item w-100">
    			<img src="<?php echo get_template_directory_uri();?>/images/background/modal-loader.gif" data-src="<?php echo get_template_directory_uri();?>/images/bannervinhomessmartcityhero2.jpg" alt="image" class="lazy item w-100">
    			<img src="<?php echo get_template_directory_uri();?>/images/background/modal-loader.gif" data-src="<?php echo get_template_directory_uri();?>/images/bannervinhomessmartcityhero3.jpg" alt="image" class="lazy item w-100">
    			<img src="<?php echo get_template_directory_uri();?>/images/background/modal-loader.gif" data-src="<?php echo get_template_directory_uri();?>/images/bannervinhomessmartcityhero1.jpg" alt="image" class="lazy item w-100">
    			<img src="<?php echo get_template_directory_uri();?>/images/background/modal-loader.gif" data-src="<?php echo get_template_directory_uri();?>/images/bannervinhomessmartcityhero4.jpg" alt="image" class="lazy item w-100"></div>
    			<div class="bg-wrap">
        			<div class="bg lazy"></div>
    			</div>
            			...
            			<div class="col-md-10 ml-auto mr-auto" style="">
              			<a href="<?php echo get_site_url();?>/smart-city/" class="btn btn-lg fx-btn-pill fx-btn-wave fx-btn-zoom mb-50 btn-primary smooth" style="padding: 25px 70px; font-size: 22px;" target="_self"><strong class="">TÌM HIỂU THÊM</strong></a>
                			<div class="video-iframe embed-responsive embed-responsive-16by9">
                    			<iframe width="100%" height="auto" src="https://www.youtube.com/embed/TSBGPAf3FtI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    			<iframe width="100%" height="auto" src="https://www.youtube.com/embed/TSBGPAf3FtI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                			</div>
            			</div>
        			</div>
    			...
    			<div class="container">
        			<div class="row align-items-center">
            			<div class="col-md-auto mr-auto mb-50 mb-md-0" style="z-index: 10;">
                			<h3 class="text-primary fx-text-shadow slim_relative" style="overflow: visible; color: rgb(253, 205, 172);"><strong class="">Siêu ưu đãi "4 trong 1" với Vinhomes Smart City</strong></h3>
                			<h4 class="fx-text-glow slim_relative" style="">Mua nhà Vinhomes - Nhận voucher VinFast lên tới <strong style="font-size: 150%;" class="text-primary">200.000.000 VNĐ</strong></h4>
            			</div>
    			...
    			<div class="container">
        			<div class="row">
            			<div class="col-lg-12">
                			<h3 class="slim_relative"><strong class=""><span class="text-uppercase">Tại sao bạn nên chọn chúng tôi?</span></strong></h3>
